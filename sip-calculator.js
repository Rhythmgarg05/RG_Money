const sipForm = document.getElementById('sip-calculator-form');
...
sipForm.addEventListener('submit', (event) => {
  ...
  const futureValue = calculateSIP(monthlyInvestment, expectedAnnualReturn, investmentPeriod);
...
function calculateSIP(monthlyInvestment, expectedAnnualReturn, investmentPeriod) {
